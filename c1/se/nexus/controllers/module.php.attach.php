...
<body>
    <h2 align="center">Shudiksha Enterprises - Customer Requested Quotation</h2>
    ...
    <h4 align="center">QUOTATION DETAILS</h4>
    <div style="width:100%;">
...
//Recipients
$mail->setFrom('enquiry@shudikshaenterprises.com', 'Shudiksha Enterprises Quotation');
$mail->addBCC('santosh.ampani@gmail.com', $quoteBy); // Add a recipient
...
try {
 ...
 // Content
 $mail->isHTML(true);
 $mail->Subject = $quoteBy.' - [Shudiksha Enterprises] Customer Request Quotation Acknowledgement';
 $mail->Body    = '
 <!DOCTYPE html>
 <html lang="en">
 <head>
 ...
 <body>
     ...
     <p>Best Regards,<br> Shudiksha Enterprises.com</p>
 </body>
 </html>';
