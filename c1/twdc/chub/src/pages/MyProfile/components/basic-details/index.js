...
const BasicDetails = () =>{
 ...
 const initialize = () =>{
    ...
    setData({ userId: userAuthDetails?.data?.userId, 
        surName: userAuthDetails?.data?.surName,
        name: userAuthDetails?.data?.name, 
 ...
 return (<div>
    ...
    {data?.surName && (<div className="mtop15p">
        <TextBox name="surname" label="Surname" placeholder="Enter your Surname" value={data?.surName} 
