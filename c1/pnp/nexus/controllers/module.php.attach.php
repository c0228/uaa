...
function generatePDF($data) {
    ...
    <body>
        <h2 align="center">PETS AND PAWS KENNEL SERVICES - QUERY REQUEST</h2>
...
function sendEmail($senders, $pdfFilePath, $subject, $bodyContent) {
    ...
    try {
        $mail->setFrom('support@petsandpawskennels.com', 'Pets and Paws Kennel Services');
...
$subject = $data['name'] . ' - Thank you for contacting Pets and Paws Kennel Services';
$body = '
<html>
<body>
    <h4>Dear ' . htmlspecialchars($data['name']) . ',</h4>
    <p>Thank you for reaching out to Pets and Paws Kennels. We appreciate your query.</p>
    <p>We\'re committed to providing you with the best service. We\'ll be in touch shortly.</p>
    <p>If your inquiry is urgent, contact us at +91 97033 03888.</p>
    <p>Sincerely,<br><u>Pets and Paws Kennel Services Team</u><br/>
       <a href="http://www.petsandpawskennels.com">www.petsandpawskennels.com</a>
    </p>
</body>
</html>';
...
$senders2 = array('nellutlalnrao@gmail.com' => 'Pets and Paws Kennel Services', 
                'support@petsandpawskennels.com' => 'Pets and Paws Kennel Services');
/** Email#2 */
$subject = 'Received a Request from '.$data['name'].' to Pets and Paws Kennel Services';
$body = '
<html>
<body>
    <h4>Hello Team,</h4>
    <p>'.htmlspecialchars($data['name']).' submited Query on Pets and Paws Kennel Services Website, Please reach out at earliest Possible, Thank you.</p>
    <p>Sincerely,<br><u>Pets and Paws Kennel Services Team</u><br/>
       <a href="http://www.petsandpawskennels.com">www.petsandpawskennels.com</a>
    </p>
</body>
