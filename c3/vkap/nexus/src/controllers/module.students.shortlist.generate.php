...
$emailAddress = htmlspecialchars($jsonObject['emailAddress']);
$mobileNumber = htmlspecialchars($jsonObject['mobileNumber']);
$studentPreferredCountry = htmlspecialchars($jsonObject['country']);
$preferredMasterDetails = htmlspecialchars($jsonObject['preferredMasterDetails']); 
$ssc = htmlspecialchars($jsonObject['ssc']); 
$inter = htmlspecialchars($jsonObject['intermediate']); 
$degree = htmlspecialchars($jsonObject['degree']); 
$empExp = htmlspecialchars($jsonObject['empYears']);
$empExpField = htmlspecialchars($jsonObject['empField']); 
$toefl_r = htmlspecialchars($jsonObject['TOEFL_Reading']);
$toefl_w = htmlspecialchars($jsonObject['TOEFL_Writing']); 
$toefl_l = htmlspecialchars($jsonObject['TOEFL_Listening']); 
$toefl_s = htmlspecialchars($jsonObject['TOEFL_Speaking']);
$toeflScore = htmlspecialchars($jsonObject['TOEFL_Overall']); 
$ielts_r = htmlspecialchars($jsonObject['IELTS_Reading']); 
$ielts_w = htmlspecialchars($jsonObject['IELTS_Writing']);
$ielts_l = htmlspecialchars($jsonObject['IELTS_Listening']); 
$ielts_s = htmlspecialchars($jsonObject['IELTS_Speaking']);
$ieltScore = htmlspecialchars($jsonObject['IELTS_Overall']); 
$pte_r = htmlspecialchars($jsonObject['PTE_Reading']);
$pte_w = htmlspecialchars($jsonObject['PTE_Writing']);
$pte_l = htmlspecialchars($jsonObject['PTE_Listening']);
$pte_s = htmlspecialchars($jsonObject['PTE_Speaking']);
$pteScore = htmlspecialchars($jsonObject['PTE_Overall']); 
$duolingoScore = htmlspecialchars($jsonObject['Duolingo_Overall']); 
$greScore = htmlspecialchars($jsonObject['GRE_Overall']); 
