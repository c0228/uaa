...
const AboutBlog = () =>{
 ...
 <div className="mtop15p mbot15p">
   <div className="list-header">About My Blogging Platform</div>
   <div className="about-blog-content">&emsp; "At <b><i>nellutlalnrao.com</i></b>, immerse yourself in a digital realm where technology comes to life. As the curator of this platform, I am dedicated to bringing you a curated experience that goes beyond traditional blogging—it's a digital tech platform designed for enthusiasts seeking a deeper understanding of the technological landscape.<br/><br/>
