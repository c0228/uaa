...
const BlogTerminologies = ({ activeId, prefix, metaData, children }) => {
  ...
  return (
    <div>
      <Header menulinks={HeaderMenu} activeId={activeId} />
      <ContainerFluid>
        <Row>
          ...
          {rightSide}
          <Terminologies title="Terminologies" prefix={prefix} data={Routes?.urls} />
...
export { BlogTerminologies, Content, RightSide };
