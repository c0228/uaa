...
const Conclusion = () =>{
 return (<div className="mtop15p lh28p fs16p">
   ...
   <div>
      <ul>
         <li className="mtop5p"><b>ES5</b> was a big step in making JavaScript consistent and widely usable.</li>
         <li className="mtop5p"><b>ES6</b> revolutionized the language, introducing features like let/const, 
         arrow functions, classes, template literals, promises, modules, default parameters, and destructuring — making 
         development more <b>readable, maintainable, and scalable.</b></li>
