 ...
 return (<div className="mtop15p mbot15p">
    <div className="blog-desc mtop15p">
        ...
        <div className="mtop5p">We respect your rights concerning your personal data and are committed to complying with applicable 
            privacy regulations, including the <b>General Data Protection Regulation (GDPR)</b>, <b>California Consumer Privacy Act (CCPA)</b>, 
        ...
        <div>
            <ol>
                ...
                <li className="mtop15p">
                    ...
                    <div>
                        <ul>
                            <li className="mtop5p">When the data is no longer necessary</li>
                            <li className="mtop5p">When you withdraw consent</li>
                            <li className="mtop5p">When the data was unlawfully processed</li>
                        </ul>
                    </div>
                ...
                <li className="mtop15p">
                    ...
                    <div>
                        <ul>
                            <li className="mtop5p">If you contest the accuracy of the data</li>
                            <li className="mtop5p">If the processing is unlawful and you oppose deletion</li>
                            <li className="mtop5p">If you need the data to establish, exercise, or defend legal claims</li>
                        </ul>
                    </div>
                </li>
                <li className="mtop15p">
                ...
                <li className="mtop15p">
                    ...
                    <div>
                        <ul>
                            <li className="mtop5p">Clicking the “unsubscribe” link in emails</li>
                            <li className="mtop5p">Adjusting preferences in your account settings (if applicable)</li>
                            <li className="mtop5p">Contacting us directly</li>
                        </ul>
                    </div>
                </li>
                <li className="mtop15p">
                    ...
                    <div className="mtop5p">If you are a California resident, you may also:
                        <ul>
                            <li className="mtop5p">Request information about the categories and specific pieces of personal data we have collected</li>
                            <li className="mtop5p">Request deletion of your personal data</li>
                            <li className="mtop5p">Opt out of the sale of your personal information (we do not sell personal data)</li>
                        </ul>
                ...
                <li className="mtop15p">
                    ...
                    <div className="mtop5p">To make a request regarding any of your rights, please contact us via:
                        <ul>
                            <li className="mtop5p"><b>Email: </b> me@nellutlalnrao.com</li>
                        </ul>
                    </div>
                    <div>We will respond to your request within the legally required timeframe, usually 30 days. In some cases, we may ask you to verify 
                        your identity before processing your request.</div>
                </li>
            </ol>
        </div>
    </div>
