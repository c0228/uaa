...
const FI_BICONSUMER_JAVA = `import java.util.function.BiConsumer;
...
const Example = () =>{
 return (<div className="mtop15p lh28p fs16p">
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #1: Using a Custom Functional Interface</b></h4></div>
    <div className="mtop5p"><Highlight content={FI_CUSTOM_JAVA} lang="java" /></div>

    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #2: Using <code>Supplier&lt;T&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_SUPPLIER_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In <code><b>Supplier&lt;Double&gt;</b></code> - the type <code><b>Double</b></code> is the 
    output <code><b>T</b></code>, and the function takes no input but supplies (returns) a value when <code><b>get()</b></code> is 
    called.</div>

    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #3: Using <code>Function&lt;T, R&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_FUNCTION_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In the expression <code><b>Function&lt;String, Integer&gt;</b></code> - <code><b>String</b></code> is 
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #4: Using <code>UnaryOperator&lt;T&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_UNARYOPERATOR_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In <code><b>UnaryOperator&lt;String&gt;</b></code> - the input and output are both of 
    type <code><b>String</b></code> (<code><b>T</b></code>), meaning it takes a single operand and returns a result of the 
    same type.</div>

    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #5: Using <code>Predicate&lt;T&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_PREDICATE_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In the expression <code><b>Predicate&lt;String&gt;</b></code> - the type <code><b>String</b></code> is 
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #6: Using <code>Consumer&lt;T&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_CONSUMER_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In <code><b>Consumer&lt;String&gt;</b></code> - the type <code><b>String</b></code> is the 
    input <code><b>T</b></code>, and it performs an action (<code><b>System.out.println</b></code>) without returning any result.</div>
        
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #7: Using <code>BiConsumer&lt;T&gt;</code></b></h4></div>
    <div className="mtop5p"><Highlight content={FI_BICONSUMER_JAVA} lang="java" /></div>
    <div className="mtop5p padLeft5p">In <code><b>BiConsumer&lt;String&gt;</b></code> - the type <code><b>String</b></code> is the 
    input <code><b>T</b></code>, and it performs an action (<code><b>System.out.println</b></code>) without returning any result.</div>
