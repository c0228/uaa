...
const Example = () =>{
 return (<div className="mtop15p lh28p fs16p">
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #2: Using <code>Function&lt;T, R&gt;</code></b></h4></div>
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #3: Using <code>Consumer&lt;T&gt;</code></b></h4></div>
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #4: Using <code>Supplier&lt;T&gt;</code></b></h4></div>
    ...
    <div className="mtop15p padLeft5p"><h4 className="blog-head"><b>Example #6: Using <code>UnaryOperator&lt;T&gt;</code></b></h4></div>
