...
const Introduction = () =>{
 return (<div>
    ...
    <div align="center" className="mtop15p"><h3><b>Zero-Knowledge Proofs in Blockchain: An Introduction</b></h3></div>
	  ...
	  <ul>
		<li className="mtop15p lh25p"><b>Enhance privacy:</b> <i>(Ensuring user transaction data remains confidential)</i><br/>
			By allowing users to prove that they have the right to perform a transaction without revealing their identities or 
			transaction details. This is particularly useful for financial transactions and other sensitive data.</li>
		<li className="mtop15p lh25p"><b>Improve scalability:</b> <i>(Improving efficiency without sacrificing decentralization)</i><br/> 
			By allowing for off-chain computations and reducing the amount of data that needs to be stored on the blockchain. 
			This can help to increase the throughput of the blockchain and reduce transaction fees.</li>
		<li className="mtop15p lh25p"><b>Increase security:</b> <i>(Maintaining trust among participants without revealing sensitive data)</i><br/> 
			By allowing for more complex and secure authentication and authorization mechanisms.</li>
	  </ul>
