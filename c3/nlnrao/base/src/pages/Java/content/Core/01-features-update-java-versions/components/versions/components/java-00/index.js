...
const Java00 = () =>{
 return (<div className="mtop15p">
    ...
    <div className="mtop15p padLeft5p">
        ...
        <div className="padLeft10p">Java 1.0's <b>first GUI framework</b> for creating window-based applications. It included:</div>
        <OrderList data={[(<div><b>Basic UI components:</b> Buttons, text fields, labels, checkboxes, etc.</div>),
            ...
            (<div><b>Layouts</b> like <code><b>FlowLayout</b></code>, <code><b>GridLayout</b></code>, and <code><b>BorderLayout</b></code>.</div>)]} />
    </div>
    <div className="mtop15p padLeft5p">
        <BlogIndexHeader type="simple" index="8" title="Java API Library" />
        <div className="padLeft10p">Core libraries such as:</div>
        <OrderList data={[(<div><b>java.lang</b> (basic classes like <code><b>String</b></code>, <code><b>Math</b></code>, <code><b>System</b></code>)</div>),
