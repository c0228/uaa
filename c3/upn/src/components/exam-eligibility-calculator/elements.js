...
const Element = ({ params }) =>{
 ...
 {params?.elementType==='textBox' && (<TextBox name={params?.id} label={params?.[label]} placeholder={params?.[placeholder]} />)}
 ...
 {params?.elementType==='radio' && (<Switch type={params?.elementType} id={params?.id} name={params?.id}  layout={params?.layout}
    label={params?.[label]} value={params?.value} options={params?.options} validation={params?.validation} />)}
 {params?.elementType==='range' && (<Range name={params?.id} label={params?.[label]} value={params?.value} validation={params?.validation} />)}
 </div>);
};
